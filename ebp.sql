...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2022. Feb 07. 18:29
...
--
-- Tábla szerkezet ehhez a táblához `reg.gazdi`
--
...
--
-- Tábla szerkezet ehhez a táblához `reg.menhely`
--
...
--
-- A tábla indexei `reg.gazdi`
--
ALTER TABLE `reg_gazdi`
  ADD PRIMARY KEY (`SORSZ`);

--
-- A tábla indexei `reg.menhely`
--
...
--
-- AUTO_INCREMENT a táblához `reg.gazdi`
--
ALTER TABLE `reg_gazdi`
  MODIFY `SORSZ` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT a táblához `reg.menhely`
--
ALTER TABLE `reg_menhely`
  MODIFY `SORSZAM` int(11) NOT NULL AUTO_INCREMENT;
